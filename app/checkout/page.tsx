      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white flex items-center justify-center p-4">
        <Card className="max-w-md w-full shadow-2xl border-2 border-green-200 bg-gradient-to-br from-green-50 to-white">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-3xl font-black text-slate-900">{t("checkout.successTitle")}</CardTitle>
          ...
          <Card className="max-w-md w-full shadow-2xl border-2 border-blue-200 bg-gradient-to-br from-white to-blue-50 animate-in fade-in zoom-in duration-300">
            <CardHeader className="text-center relative">
              ...
              <CardTitle className="text-3xl font-black text-slate-900 mb-2">
                {t("checkout.jokeTitle")}
              </CardTitle>
              <CardDescription className="text-base mt-2 space-y-2">
                <p className="text-slate-700">
                  {t("checkout.jokeDesc")}
                  <span className="font-semibold italic">{t("checkout.jokeDescEnd")}</span>
                </p>
                <p className="text-slate-600 mt-3">
                  {t("checkout.jokeCongrats")}
                </p>
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-slate-700 text-center">
                  <span className="font-semibold">{t("checkout.thanks")}</span>
                </p>
                <p className="text-xs text-slate-600 text-center mt-2">
                  {t("checkout.share")}
                </p>
                <p className="text-xs text-slate-600 text-center mt-2">
                  {t("checkout.contact")} <a href="mailto:contact@flmtech.fr">mrtn.flmt@gmail.com</a>
                </p>
              </div>
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8">
              <h1 className="text-4xl font-black mb-2 text-slate-900">{t("checkout.title")}</h1>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="md:col-span-2">
                <Card className="shadow-xl border-2 border-slate-200">
                  <CardHeader>
                    <CardTitle className="text-2xl font-bold">{t("checkout.deliveryTitle")}</CardTitle>
              ...
              <div>
                <Card className="shadow-xl border-2 border-slate-200 sticky top-24 bg-gradient-to-br from-slate-50 to-white">
                  <CardHeader>
                    <CardTitle className="text-xl font-bold">{t("checkout.summaryTitle")}</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between p-3 bg-white rounded-lg border border-slate-200">
                        <span className="text-slate-600">{t("home.order.shipping")}</span>
                        <span className="text-green-600 font-bold">{t("home.order.free")}</span>
                      </div>
                      <div className="flex justify-between p-3 bg-white rounded-lg border border-blue-200 bg-blue-50/50">
                        <span className="text-slate-600">{t("checkout.reduction")}</span>
                      ...
                      <div className="flex justify-between p-4 bg-gradient-to-r from-slate-900 to-slate-700 rounded-lg text-white">
                        <span className="text-lg font-bold">{t("home.order.total")}</span>
